      ...
      <Box bgColor="#FFFFFF">
        ...
        <Box my="6rem">
          ...
          <Flex gap=".5rem" justifyContent="center" flexWrap="wrap" padding={contentPadding}>
            <Image src={oilgas1} alt="ride1" style={{ maxWidth: '100%', height: 'auto' }}/>
            <Image src={oilgas2} alt="ride1" style={{ maxWidth: '100%', height: 'auto' }}/>
            <Image src={oilgas3} alt="ride1" style={{ maxWidth: '100%', height: 'auto' }}/>
          </Flex>
        </Box>
